...
import { FloatingActionButton, FloatingActionButtonCSS } from '../Components/UI/';
export const ButtonsPage = () => {
  return (
    <Section title="Botones" child={<Content></Content>}/>
  )
}
    ...
    return (
        <article>
            ...
            <div>
                ...
                <br />
                <button className="btnl r-btn" style={{backgroundColor:'dodgerblue'}}>Button</button>
                {/*
                <FloatingActionButton width={3}
                    items={[
